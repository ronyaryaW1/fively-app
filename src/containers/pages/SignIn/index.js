    ...
    render() {
        return (
            <View style={{ paddingHorizontal: 16 }}>
                ...
                <TouchableOpacity style={{ marginTop: 10, flexDirection: 'row', alignSelf: 'flex-end' }}>
                ...
                <View style={{ alignItems: 'center', marginTop: 34 }}>
                    <TouchableOpacity style={{ width: 330, height: 50, backgroundColor: 'red', borderRadius: 30, justifyContent: 'center' }} onPress={() => this.props.navigation.navigate('MainPage')}>
                        <Text style={{ color: 'white', fontSize: 14, textAlign: 'center' }}>LOGIN</Text>
                    </TouchableOpacity>
                </View>
                <View style={{ marginTop: 20 }}>
                    <Text style={{ textAlign: 'center' }}>Or login with social account</Text>
                </View>
